...
const {updateProject,newTweetProject,approveTweet,changeTeamMember_Phase_Project} = require("./mutation/projectsMutation");
...
module.exports = {
  Mutation: {
    ...
    updateProject,
    newTweetProject,
    approveTweet,changeTeamMember_Phase_Project,
