...
const { forEachDefaultValue } = require("@graphql-tools/utils");
...
module.exports = {
    ...
    try {
      ...
      if (mentioned && mentioned.length === 0)
        throw new ApolloError(
          "The mentioned array length must be greater than 0"
        );
  ...
  addMessages: async (parent, args, context, info) => {
    ...
    try {
      ...
      throw new ApolloError(err.message, err.extensions?.code || "addMessages", {
