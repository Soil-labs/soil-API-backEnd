...
const { Members,matchMembersToUserOutput,matchMembersToProjectOutput,matchMembersToSkillOutput } = require('./objectResolvers/memberResolver');
...
module.exports = {
    ...
    Mutation,
    Subscription,
    Members,matchMembersToUserOutput,matchMembersToProjectOutput,matchMembersToSkillOutput,
