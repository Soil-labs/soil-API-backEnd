...
const { Members,matchMembersToUserOutput,skillType_member,matchMembersToSkillOutput } = require('./objectResolvers/memberResolver');
...
module.exports = {
    ...
    Mutation,
    Subscription,
    Members,matchMembersToUserOutput,skillType_member,matchMembersToSkillOutput,
